...
public final class ItemArticleBinding implements ViewBinding {
  ...
  private ItemArticleBinding(@NonNull LinearLayout rootView, @NonNull TextView itemAmount,
      @NonNull TextView itemDate) {
  ...
  public static ItemArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemArticleBinding((LinearLayout) rootView, itemAmount, itemDate);
    }
